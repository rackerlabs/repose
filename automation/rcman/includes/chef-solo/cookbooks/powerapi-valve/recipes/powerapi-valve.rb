...
for nodeNumber in 1..6
   ...
   when 3
      ...
      ["uri-identity.cfg.xml", "content-normalization.cfg.xml", "response-messaging.cfg.xml", "ip-identity.cfg.xml", "header-identity.cfg.xml", "rate-limiting.cfg.xml", "dist-datastore.cfg.xml", "responsefor5xx", "content-identity-auth-1-1.cfg.xml", "header-id-mapping.cfg.xml", "default.wadl", "group1.wadl", "group2.wadl", "test.xsd", "validator.cfg.xml","keystone-auth.cfg.xml"].each do |config|
