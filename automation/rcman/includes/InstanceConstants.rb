...
REPOSE_INSTANCES = [REPOSE_INST_AUTH_11, REPOSE_INST_OS_IDENTITY, REPOSE_INST_CLIENT_IP, REPOSE_INST_DD_1, REPOSE_INST_DD_2, REPOSE_INST_DD_3,REPOSE_INST_ROOT_WAR]
