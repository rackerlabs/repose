...
== Upcoming Release 9.1.1.0 (2023-09-??)
* Updated dependencies:
** Log4j: 2.17.1 → 2.19.0
** Http Client: 4.5.6 -> 4.5.13
** Jena IRI: 1.1.1 -> 1.1.2
** Libthrift: 0.12.0 -> 0.14.1
** Jackson: 2.9.10 -> 2.15.2
** Json Path: 2.4.0 -> 2.8.0
** Flume NG: 1.9.0 -> 1.11.0
** Handlebars: 2.0.0 -> 4.3.1
** Guava: 27.0.0-jre -> 32.0.0-jre
** Commons IO: 2.4 -> 2.7
** Groovy: 2.4.15 -> 2.4.21
** Jython: 2.7.1 -> 2.7.3
** Spring: 4.3.21.RELEASE -> 5.3.27
** Xalan: 2.7.2 -> 2.7.3
