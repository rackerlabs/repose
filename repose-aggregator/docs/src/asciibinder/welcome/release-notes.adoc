...
== In Progress
* https://repose.atlassian.net/browse/REP-7391[REP-7391] - Updated dependencies:
** Jetty: 9.4.8.v20171121 → 9.4.14.v20181114
* https://repose.atlassian.net/browse/REP-7150[REP-7150] - Added OWASP security dependency checking to the build.
