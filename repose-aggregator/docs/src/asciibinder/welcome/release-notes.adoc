...
* [.new-tag]#New# | https://repose.atlassian.net/browse/REP-7600[REP-7600] | https://repose.atlassian.net/browse/REP-7789[REP-7789] - Added the <<../filters/openapi-validator.adoc#, OpenApi Validator Filter>> which provides *Swagger/OpenApi* api validation support.
