...
== In Progress
* [.breaking-tag]#Breaking Change# | https://repose.atlassian.net/browse/REP-7785[REP-7785] - Implemented a Hazelcast-backed datastore.
** Removed the existing Distributed datastore.
** Removed the existing Remote datastore.
** Updated the Datastore, Datastore Service, and Datastore Patch APIs to support the Hazelcast datastore.
