...
wget -O - https://nexus.openrepose.org/repository/el/RPM_GPG_KEY-openrepose | sudo apt-key add -
sudo sh -c 'echo "deb https://nexus.openrepose.org/repository/debian stable main" > /etc/apt/sources.list.d/openrepose.list'
sudo apt-get update

# install Repose
sudo apt-get install -y repose repose-filter-bundle repose-extensions-filter-bundle
----
...
# add openrepose.org repository
sudo wget -O /etc/yum.repos.d/openrepose.repo https://nexus.openrepose.org/repository/el/openrepose.repo

# install Repose
sudo yum install -y repose repose-filter-bundle repose-extensions-filter-bundle
----
