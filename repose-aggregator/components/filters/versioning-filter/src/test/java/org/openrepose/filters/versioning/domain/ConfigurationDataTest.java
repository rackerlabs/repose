...
public class ConfigurationDataTest {
    ...
    public void shouldReturnVersionedOriginServiceFromAcceptHeader() throws VersionedHostNotFoundException {
        ...
        when(request.getPreferredSplittableHeadersWithParameters(CommonHttpHeader.ACCEPT)).thenReturn(Collections.singletonList("application/vnd.vendor.service-v1+xml"));
