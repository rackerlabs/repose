...
public class MediaTypeNormalizerTest {
    ...
    public static class WhenNormalizingVariantExtensions {
        ...
        public void shouldSetCorrectMediaTypeWhenWildCardIsProvided(){
            ...
            assertTrue(director.requestHeaderManager().headersToAdd().keySet().contains(new HeaderNameStringWrapper("accept")));
            assertTrue(director.requestHeaderManager().headersToAdd().get(new HeaderNameStringWrapper("accept")).contains("application/xml"));
        }
