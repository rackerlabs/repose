...
public class HttpLoggingFilterTest {
    ...
    public static class BaseTest {
        ...
        protected Slf4jHttpLoggingFilter filter;
        ...
        public void setup() throws NamingException {
            filter = new Slf4jHttpLoggingFilter();
    ...
    public static class WhenInitializing extends BaseTest {
        ...
        public void shouldSubscribeToConfigFile() throws ServletException {
            ...
            verify(configService).subscribeTo(eq(filterConfig.getFilterName()),eq("http-slf4jlogging.cfg.xml"), eq(xsdURL), any(Slf4jHttpLoggingHandlerFactory.class), any(Class.class));
        }
    }
    ...
    public static class WhenDestroying extends BaseTest {
        ...
        public void shouldUnsubscribeFromConfigFile() throws ServletException {
            filter.init(filterConfig);
            filter.destroy();
            verify(configService).unsubscribeFrom(eq("http-slf4jlogging.cfg.xml"), any(Slf4jHttpLoggingHandlerFactory.class));
        }
    }
