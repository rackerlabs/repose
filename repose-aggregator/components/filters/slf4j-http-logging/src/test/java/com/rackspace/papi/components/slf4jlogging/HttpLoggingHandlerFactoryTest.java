...
import com.rackspace.papi.components.slf4jlogging.config.FileTarget;
import com.rackspace.papi.components.slf4jlogging.config.HttpLog;
import com.rackspace.papi.components.slf4jlogging.config.HttpLoggingConfig;
import com.rackspace.papi.components.slf4jlogging.config.Targets;
...
public class HttpLoggingHandlerFactoryTest {
   ...
   public static class WhenGettingListeners {
      private Slf4jHttpLoggingHandlerFactory instance;
      @Before
      public void setUp() {
         instance = new Slf4jHttpLoggingHandlerFactory();
      }
...
//         targets.getFile() =null;
      ...
      public void shouldGetHandler() {
         Slf4jHttpLoggingHandler result = instance.buildHandler();
