...
class OpenStackIdentityBasicAuthFilter extends Filter {
  ...
  private final val DEFAULT_CONFIG = "openstackidentity-basic-auth.cfg.xml"
  ...
  override def init(filterConfig: FilterConfig) {
    ...
    val xsdURL: URL = getClass.getResource("/META-INF/config/schema/openstackidentity-basic-auth.xsd")
