...
public class HeaderIdMappingHandlerTest {
   ...
   public static class WhenHandlingRequests {
      ...
      public void shouldSetTheUserHeaderToTheHeaderValue() {
         ...
         Set<String> values = result.requestHeaderManager().headersToAdd().get(new HeaderNameStringWrapper(PowerApiHeader.USER.toString()));
         ...
         Set<String> groups = result.requestHeaderManager().headersToAdd().get(new HeaderNameStringWrapper(PowerApiHeader.GROUPS.toString()));
