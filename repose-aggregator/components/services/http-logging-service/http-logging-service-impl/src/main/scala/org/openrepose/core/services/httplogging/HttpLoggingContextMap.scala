...
object HttpLoggingContextMap {
  ...
  private final val Generators: Map[String, HttpLoggingContext => Any] = Map(
    ...
    "inboundRequestUrl" -> (_.getInboundRequest.getRequestURL.toString),
    "outboundRequestUrl" -> (_.getOutboundRequest.getRequestURL.toString),
    ...
    "outboundResponseStatusCode" -> (_.getOutboundResponseStatusCode),
    ...
    "impersonatorUserId" -> (_.getImpersonatorId),
    "impersonatorUserName" -> (_.getImpersonatorName),
