...
class PowerFilterChainTest extends Specification {
    ...
    def "startFilterChain correctly handles header #headerName"() {
        ...
        def powerFilterChain = new PowerFilterChain([], null, null, Optional.empty(), Optional.empty(), Optional.empty()) {
            @Override
    ...
    def "doRouting correctly handles header #headerName"() {
        ...
        def powerFilterChain = new PowerFilterChain([], mock(FilterChain), router, Optional.empty(), Optional.empty(), Optional.empty())
