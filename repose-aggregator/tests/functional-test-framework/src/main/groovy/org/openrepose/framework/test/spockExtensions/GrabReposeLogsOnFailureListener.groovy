 ...
 * =_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_=_
 */
package org.openrepose.framework.test.spockExtensions
...
class GrabReposeLogsOnFailureListener extends AbstractRunListener {
    ...
    void beforeSpec(SpecInfo spec) {
        ...
        def properties = new TestProperties(spec.reflection.canonicalName.replace('.', '/'))
    ...
    void error(ErrorInfo error) {
        ...
        def properties = new TestProperties(error.method.parent.reflection.canonicalName.replace('.', '/'))
