...
@Category(Filters)
class UriStripperRequestLinkResourceXmlInvalidXpathTest extends ReposeValveTest {
    ...
    def setupSpec() {
        ...
        repose.configurationProvider.applyConfigs("features/filters/uristripper/linkresource/request/xml/invalidxpath", params)
        repose.start()
    }

    def "when an invalid XPath is configured, repose fails to start"() {
        given:
