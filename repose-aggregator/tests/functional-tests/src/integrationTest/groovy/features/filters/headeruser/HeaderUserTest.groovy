 ...
 * =_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_=_
 */
package features.filters.headeruser
...
class HeaderUserTest extends ReposeValveTest {
    ...
    def setupSpec() {
        ...
        repose.configurationProvider.applyConfigs("features/filters/headeruser", params)
        repose.start()
    ...
    def "when identifying requests by header"() {
        ...
        and: "Repose will send x-pp-user based on incoming user header"
        ((Handling) sentRequest).request.getHeaders().findAll("x-pp-user").contains(expecteduser + ";q=0.2")

        and: "Repose will send x-pp-groups with the value of the targeted user header"
