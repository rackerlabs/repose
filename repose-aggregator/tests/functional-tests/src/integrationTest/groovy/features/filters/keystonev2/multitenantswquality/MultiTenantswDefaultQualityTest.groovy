 ...
 */
@Category(Identity)
class MultiTenantswDefaultQualityTest extends ReposeValveTest {
    ...
    def setupSpec() {
        ...
        repose.configurationProvider.applyConfigs("features/filters/keystonev2/multitenantswquality/default", params)
        repose.start()
    ...
    @Unroll("Defaul quality with request teanant: #requestTenant")
    def "when user token have multi-tenant will retrieve all tenants in the header with default quality"() {
        given:
