...
@Category(Slow)
class CullingWFlexibleDeviceOptionsFailTest extends ReposeValveTest {
    ...
    @Unroll
    def "Fail - permission: #permission for #method with tenant: #tenantID and deviceIDs: #deviceID, #deviceID2 should return a #responseCode"() {
