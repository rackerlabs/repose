...
class CullingWFlexibleDeviceOptionsRemoveTest extends ReposeValveTest {
    ...
    @Unroll
    def "Remove - permission: #permission for #method with tenant: #tenantID and deviceIDs: #deviceID, #deviceID2 should return a #responseCode"() {
