...
class OpenTracingServiceMisconfiguredSamplingConfigTest extends ReposeValveTest {
    ...
    def setupSpec() {
        ...
        repose.configurationProvider.applyConfigs("features/services/opentracing/misconfiguredsampling", params)
    ...
    def "when OpenTracing config has invalid sampling, no trace information is passed in tracing header"() {
    ...
    def "when OpenTracing config has invalid sampling, and trace id passed in, new span is not created, and trace id is passed through"() {
