...
class OpenTracingServiceInvalidHostTest extends ReposeValveTest {
    ...
    def setupSpec() {
        ...
        repose.configurationProvider.applyConfigs("features/services/opentracing/invalidhost", params)
    ...
    def "when OpenTracing config has invalid host, no trace information is passed in x-trans-id header"() {
