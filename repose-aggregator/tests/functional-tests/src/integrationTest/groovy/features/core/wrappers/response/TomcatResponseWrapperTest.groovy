...
class TomcatResponseWrapperTest extends Specification {
    ...
    @Shared
    ReposeContainerLauncher tomcatLauncher
    ...
    def setupSpec() {
        ...
        tomcatLauncher = new ReposeContainerLauncher(
            configurationProvider,
            properties.tomcatJar,
