...
class BasicAuthPasswordWKeystonev2Test extends ReposeValveTest {
    ...
    def setupSpec() {
        ...
        repose.configurationProvider.applyConfigs("features/filters/identitybasicauth/wpassword/wkeystonev2", params);
        repose.start()
