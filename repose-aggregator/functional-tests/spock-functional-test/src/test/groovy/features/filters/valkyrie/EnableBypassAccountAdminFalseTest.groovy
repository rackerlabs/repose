 ...
 */
class EnableBypassAccountAdminFalseTest extends ReposeValveTest {
    ...
    def setupSpec() {
        ...
        repose.configurationProvider.applyConfigs("features/filters/valkyrie/accountadmin/enablebypassfalse", params);
    ...
    def "enablebypass false, account_admin user request with an X-Device-Id header value not contained in the user's permissions will not be permitted"() {
        ...
        "HEAD"   | randomTenant() | "403"
        "GET"    | randomTenant() | "403"
        "PUT"    | randomTenant() | "403"
        "POST"   | randomTenant() | "403"
        "DELETE" | randomTenant() | "403"
        "PATCH"  | randomTenant() | "403"
    }

    @Unroll("device id exist - account_admin for #method with tenant: #tenantID should return a #responseCode")
