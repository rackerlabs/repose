 ...
 */
class ApiValidatorDelegatingWKeystonev2DelegatingTest extends ReposeValveTest {
    ...
    def setupSpec() {
        ...
        repose.configurationProvider.applyConfigs("features/filters/apivalidator/delegable/wkeystonev2", params)
        repose.configurationProvider.applyConfigs("features/filters/apivalidator/delegable/wkeystonev2/keystonev2delegating", params)
        repose.start()
