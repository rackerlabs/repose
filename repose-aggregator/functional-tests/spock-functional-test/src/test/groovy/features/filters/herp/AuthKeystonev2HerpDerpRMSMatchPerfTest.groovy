...
/**
 * Created by jennyvo on 10/14/15.
 */
class AuthKeystonev2HerpDerpRMSMatchPerfTest extends ReposeValveTest {
    ...
    def setupSpec() {
        ...
        repose.configurationProvider.applyConfigs("features/filters/herp/apivalidatormultimatch/wkeystonev2preference", params)
