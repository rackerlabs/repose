 ...
 */
class AuthApivalidatorDerpWDelegatingQualityTest extends ReposeValveTest {
    ...
    def setupSpec() {
        ...
        repose.configurationProvider.applyConfigs("features/filters/derp/responsemessaging/keystonev2/apivalidatordelegating", params)
