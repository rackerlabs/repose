 ...
 * =_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_=_
 */
package features.filters.cloudfeedstests
...
/**
 * Created by jennyvo on 7/29/15.
 */
class CloudFeedConfigWIntrafilterTraceTest extends ReposeValveTest {
    ...
    def setupSpec() {
        ...
        repose.configurationProvider.applyConfigs("features/filters/cloudfeedsconfig", params)
