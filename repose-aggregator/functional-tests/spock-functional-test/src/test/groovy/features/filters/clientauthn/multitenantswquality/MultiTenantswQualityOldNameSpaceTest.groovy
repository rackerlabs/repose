...
/**
 * Created by jamesc on 2/2/15.
 */
class MultiTenantswQualityOldNameSpaceTest extends ReposeValveTest{
    ...
    def setupSpec() {
        ...
        repose.configurationProvider.applyConfigs("features/filters/clientauthn/multitenantswquality/oldnamespace", params)
        repose.start()
