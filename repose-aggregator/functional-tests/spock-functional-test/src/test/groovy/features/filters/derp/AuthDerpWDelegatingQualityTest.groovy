 ...
 */
class AuthDerpWDelegatingQualityTest extends ReposeValveTest {
    ...
    */
    ...
    @Unroll("tenant: #requestTenant, response: #responseTenant, and #msgBody")
    ...
    def "When req with invalid token using delegable mode with quality"() {
        ...
        /* expected internal delegated messages to derp from keystone-v2:
