...
* https://repose.atlassian.net/browse/REP-5343[REP-5343] - Updated the Keystone v2 filter so support the new Apply RCN Roles feature of Rackspace Keystone V2 Identity.
...
* https://repose.atlassian.net/browse/REP-5438[REP-5438] - the <<filters/attribute-mapping-policy-validation.adoc#,Attribute Mapping Policy Validation Filter>> has been released!
