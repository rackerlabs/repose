...
* https://repose.atlassian.net/browse/REP-6604[REP-6604] - Update to the <<filters/valkyrie-authorization.adoc#, Valkyrie Filter>> to add roles to the `X-Map-Roles` header when role translation is configured.
