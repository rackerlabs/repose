...
* https://repose.atlassian.net/browse/REP-6839[REP-6839] - Updated dependencies:
** Attribute Mapper: 2.2.1 → 2.3.0
*** https://github.com/rackerlabs/attributeMapping/blob/attribute-mapper-2.3.0/RELEASE.md[Attribute Mapper v2.3.0 release notes]
