...
====
* https://repose.atlassian.net/browse/REP-6550[REP-6550] - Update the <<filters/valkyrie-authorization.adoc#, Valkyrie Filter>> to care about quality when selected a tenant ID for talking to the Valkyrie service.
* https://repose.atlassian.net/browse/REP-66040[REP-660450] - Update to the <<filters/valkyrie-authorization.adoc#, Valkyrie Filter>> to add roles to the `X-Map-Roles` header when role translation is configured.
...
* https://repose.atlassian.net/browse/REP-6654[REP-6654] - OpenTracing support
