...
* https://repose.atlassian.net/browse/REP-4992[REP-4922] - Removed ambiguous setting for chunked encoding options on <<services/http-connection-pool.adoc, HTTP Client/Connection Pool Service>>.
