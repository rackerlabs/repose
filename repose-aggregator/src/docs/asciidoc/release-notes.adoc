...
* https://repose.atlassian.net/browse/REP-7064[REP-7064] - Fixed the behavior of the Valkyrie filter where only the last device permission was considered when determining the authorization status of a request.
