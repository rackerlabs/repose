...
== In Progress
* https://repose.atlassian.net/browse/REP-7004[REP-7004] - Fixed a bug in the Keystone v2 Basic Auth, Keystone v2, Openstack Identity v3, and Valkyrie Authorization filters were headers were potentially processed in a case sensitive way.
