...
----                ----- --- ---- --- ------------- ------------- ------------- ------------- -------                  ----------    ------ ------
1492629621000000000 2     219  205 192 192           219           219           219           getComputers           computerworld all    12
....
<1> The name of the measurement.

To learn more about how InfluxDB handles Graphite input, see the https://github.com/influxdata/influxdb/blob/master/services/graphite/README.md[Graphite Input README].
