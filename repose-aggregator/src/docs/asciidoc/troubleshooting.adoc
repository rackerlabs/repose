...
== Intrafilter Logging
WARNING: This should be used in a controlled environment (i.e. not production) and should not be used for more than a few minutes at a time due to the amount of logging that occurs.
...
NOTE: The TRACE setting is the most verbose logging setting.
...
----
Trans-Id:f863f80f-914d-4c01-a579-648673206a96 - 2015-12-04 11:10:57,527 655550 [qtp1589228348-31] INFO org.openrepose.powerfilter.PowerFilter - Tracing header: {"requestId":"f863f80f-914d-4c01-a579-648673206a96","origin":null}
