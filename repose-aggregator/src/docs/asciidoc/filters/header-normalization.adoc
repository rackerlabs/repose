...
----
<1> Since neither the uri-regex or http-methods are specified, this target applies to all requests.
...
----
<1> Since neither the uri-regex or http-methods are specified, this target applies to all responses.
...
<10> Since neither the uri-regex and http-methods are specified, this target applies to all requests and responses that don't match one of the previous targets.
