...
=== APT Package Manager Based Linux Distributions
*IN PROGRESS*

=== Yum Package Manager Based Linux Distributions
*IN PROGRESS*

== WAR Deployment
*IN PROGRESS*

=== APT Package Manager Based Linux Distribution
*IN PROGRESS*
...
.system-model.cfg.xml – PARTIAL FILE
[source,xml]
----
