...
Please follow the https://docs.docker.com/engine/installation/[installation instructions for Docker Container Engine] since that is outside the scope of this Quick Start guide.
