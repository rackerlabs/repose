...
//        "Connection"         | "keep-alive, x-header"                                               | 2
//        "Connection"         | "keep-alive, x-header-1, x-header2"                                  | 3
        ...
        "Expect"             | "100-continue, 100-continue"                                         | 2
        "Expect"             | "100-continue, x-expectation-1, x-expectation-2"                     | 3
        "Pragma"             | "no-cache"                                                           | 2
        "Pragma"             | "no-cache, x-pragma"                                                 | 2
        "Pragma"             | "no-cache, x-pragma-1, x-pragma-2"                                   | 2
//        "Proxy-Authenticate" | "Basic QWxhZGRpbjpvcGVuIHNlc2FtZQ=="                                 | 1
//        "Proxy-Authenticate" | "Basic QWxhZGRpbjpvcGVuIHNlc2FtZQ==, Basic QWxhZGRpbjpwbGVhc2U/Cg==" | 2
//        "TE"                 | ""                                                                   | 1
//        "TE"                 | "deflate"                                                            | 1
//        "TE"                 | "trailers, deflate;q=0.5"                                            | 2
//        "Trailer"            | "x-header"                                                           | 1
//        "Trailer"            | "x-header1, x-header2"                                               | 2
//        "Transfer-Encoding"  | "identity"                                                           | 1
//        "Transfer-Encoding"  | "identity, identity"                                                 | 2
//        "Transfer-Encoding"  | "identity, identity, identity"                                       | 3
