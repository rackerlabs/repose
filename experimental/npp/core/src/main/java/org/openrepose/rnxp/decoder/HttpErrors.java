...
public class HttpErrors {
    ...
    private static final HttpErrorPartial BAD_STATUS_CODE = new HttpErrorPartial(HttpMessageComponent.HEADER, HttpStatusCode.BAD_REQUEST, "Bad status code value");
