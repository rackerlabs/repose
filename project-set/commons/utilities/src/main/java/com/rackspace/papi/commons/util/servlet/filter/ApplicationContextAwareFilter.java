...
/**
 * This class serves as an abstraction parent to any number of IOC Containers
 * herefore referenced as the application context. This is not a naming context
 * in the JNDI sense nor is it the Servlet context.
 * 
 */
