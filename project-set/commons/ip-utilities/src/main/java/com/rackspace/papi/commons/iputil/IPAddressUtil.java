 ...
 * questions.
 */
package com.rackspace.papi.commons.iputil;
...
public class IPAddressUtil {
    ...
    *
    * @param src a String representing an IPv6 address in textual format @return
   ...
   /*
    * Convert IPv4-Mapped address to IPv4 address. Both input and returned value
    * are in network order binary form.
    *
    ...
    *
    * @return a
    * <code>boolean</code> indicating if the InetAddress is an IPv4 mapped IPv6
    * address; or false if address is IPv4 address.
    */
