...
import org.openrepose.rackspace.auth_2_0.identity.parsers.xml.XmlAuthContentParser;
...
public class ContentParser {
   ...
   public ContentParser(JacksonJaxbTransform jsonTranformer, Transform<InputStream, JAXBElement<?>> xmlTransformer) {
