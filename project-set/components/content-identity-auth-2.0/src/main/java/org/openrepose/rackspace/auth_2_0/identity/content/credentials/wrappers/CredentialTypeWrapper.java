...
public abstract class CredentialTypeWrapper<T extends CredentialType> implements AuthCredentials {
   public final static List<Class<? extends CredentialTypeWrapper>> wrappers = new ArrayList<Class<? extends CredentialTypeWrapper>>();
   static {
   ...
   public CredentialTypeWrapper() {
      fields = null;
   }

   public CredentialTypeWrapper(String[] fields) {
      this.fields = fields;
   }
