...
public class XmlFilterChainPoolTest {
    ...
    public static class WhenMatchingPoolCriteria {
        ...
        public void setUp() {
            ...
            responsePoolForXml = new XsltChainPool("application/xml", "application/xml", "4[\\d]{2}", "blah", null, null);
            requestPoolForXml = new XsltChainPool("application/xml", "application/xml", httpMethods, "blah", null, null);
        }
