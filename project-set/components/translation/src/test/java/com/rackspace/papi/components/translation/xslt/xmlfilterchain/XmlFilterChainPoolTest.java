...
public class XmlFilterChainPoolTest {
    ...
    public static class WhenMatchingPoolCriteria {
        ...
        private XmlFilterChainPool responsePoolForXml;
        private XmlFilterChainPool requestPoolForXml;
        ...
        public void setUp() {
            ...
            responsePoolForXml = new XmlFilterChainPool("application/xml", "application/xml", "4[\\d]{2}", "blah", null, null);
            requestPoolForXml = new XmlFilterChainPool("application/xml", "application/xml", httpMethods, "blah", null, null);
        }
