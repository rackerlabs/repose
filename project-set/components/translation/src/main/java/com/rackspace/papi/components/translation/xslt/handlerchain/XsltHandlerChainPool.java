...
public class XsltHandlerChainPool {
     ...
     * @param pool 
     */
    public XsltHandlerChainPool(String contentType, String accept, String statusRegex, String resultContentType, List<Parameter> params, Pool<XsltHandlerChain> pool) {
     ...
     * @param pool 
     */
    public XsltHandlerChainPool(String contentType, String accept, List<HttpMethod> httpMethods, String resultContentType, List<Parameter> params, Pool<XsltHandlerChain> pool) {
        this.contentType = contentType;
        this.acceptAllContentTypes = StringUtilities.nullSafeEqualsIgnoreCase(this.contentType, MimeType.WILDCARD.getMimeType());
        this.accept = accept;
        this.acceptAll = StringUtilities.nullSafeEqualsIgnoreCase(this.accept, MimeType.WILDCARD.getMimeType());
