...
public class OpenStackAuthenticationHandlerTest {
    ...
    public static abstract class TestParent {
        ...
        public void beforeAny() {
            ...
            handler = new OpenStackAuthenticationHandler(osauthConfig, authService, keyedRegexExtractor, null, new UriMatcher(whiteListRegexPatterns), null);


            // Handler with cache
            store = mock(Datastore.class);
            OpenStackUserInfoCache cache = new OpenStackUserInfoCache(store);
            OpenStackGroupInfoCache grpCache = new OpenStackGroupInfoCache(store);

            handlerWithCache = new OpenStackAuthenticationHandler(osauthConfig, authService, keyedRegexExtractor, cache, new UriMatcher(whiteListRegexPatterns), grpCache);
        }
