...
public class HttpResponseDecoderTest {
    ...
    public static class WhenDecodingRequestHttpVersion extends HttpDecoderTestPart {
        ...
        public void shouldDecodeValidHttpVersions() throws Exception {
            ...
            final ChannelBuffer buffer = copiedBuffer("HTTP/1.1 ".getBytes(CharsetUtil.US_ASCII));
    ...
    public static class WhenDecodingResponseContent extends HttpDecoderTestPart {
        ...
        public void shouldDecodeStaticLengthContent() throws Exception {
            ...
            for (int i = 0; i < expectedContent.length - 1;) {
                final HttpMessagePartial rawHttpMessagePartial = (HttpMessagePartial) decoder.decode(buffer);
