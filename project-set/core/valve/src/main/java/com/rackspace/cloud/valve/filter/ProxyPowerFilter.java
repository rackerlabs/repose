...
/**
 *
 * This class has been marked deprecated in favor of delegating routing decisions
...
public class ProxyPowerFilter extends PowerFilter {
   ...
   private String getHostUrl(Host host) {
      ...
      if (host == null) {
         ...
         hostString.append("http://").append(host.getHostname()).append(":").append(host.getServicePort());
