 ...
 */
package com.rackspace.papi.external.testing.dummyfilter.filterb;
...
public class FilterB implements Filter {
   ...
   private static final Logger LOG = LoggerFactory.getLogger(FilterB.class);
   ...
   public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
      ...
      mutableHttpRequest.addHeader("Filter B", "B");
