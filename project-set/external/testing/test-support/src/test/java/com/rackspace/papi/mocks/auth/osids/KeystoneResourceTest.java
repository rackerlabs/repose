...
public class KeystoneResourceTest {
   ...
   public static class WhenGettingTokens extends TestParent {
      ...
      public void shouldValidateToken() {
         UriInfo uriInfo = mock(UriInfo.class);
         Response response = keystoneResource.validateToken(VALID_USER_TOKEN, AUTH_TOKEN, uriInfo);
      ...
      public void shouldNotValidateInvalidToken() {
         UriInfo uriInfo = mock(UriInfo.class);
         Response response = keystoneResource.validateToken("Blah", AUTH_TOKEN, uriInfo);
      ...
      public void shouldNotValidateTokenUsingInvalidAuthToken() {
         UriInfo uriInfo = mock(UriInfo.class);
         Response response = keystoneResource.validateToken(VALID_USER_TOKEN, "Blah", uriInfo);
