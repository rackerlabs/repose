...
//        
        ...
        public void shouldReturnValidToken() {
            ...
            when(serviceClient.get(authEndpoint + "/token/" + inputToken, "belongsTo", inputUser, "type", inputType)).thenReturn(serviceClientResponse);
        ...
        public void shouldReturnUsersGroup() {
            ...
            when(serviceClientResponse.getData()).thenReturn(data);
            when(serviceClientResponse.getStatusCode()).thenReturn(200);
            when(serviceClient.get(authEndpoint + "/users/" + userId + "/groups")).thenReturn(serviceClientResponse);
