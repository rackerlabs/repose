...
import org.vafer.jdeb.producers.NewDirectoryDataProducer;
...
public final class Data implements DataProducer {
    ...
    public void produce(final DataConsumer pReceiver) throws IOException {
        ...
        if ("make-directory".equalsIgnoreCase(type)) {
            new NewDirectoryDataProducer(includePatterns, excludePatterns, mappers).produce(pReceiver);
            return;
        }
